...
set work [file join $fpga build usb3_harmonic_stream_noise_2k]
set vendor [file join $fpga vendor ch569_loopback_baseline]
file mkdir $work
create_project ch4_usb3_harmonic_stream_noise_2k $work -part xc7a200tfbg484-2 -force
...
synth_design -top ch4_usb3_imaging_stream_top -part xc7a200tfbg484-2 -generic {HARMONIC_ONLY=1}
...
if {$worst < 0.0} {error "USB3 harmonic timing failed: WNS=$worst ns"}
write_bitstream -force [file join $work ch4_usb3_harmonic_stream_noise_2k.bit]
puts "USB3_HARMONIC_STREAM_BITSTREAM_PASS [file join $work ch4_usb3_harmonic_stream_noise_2k.bit]"
close_project
