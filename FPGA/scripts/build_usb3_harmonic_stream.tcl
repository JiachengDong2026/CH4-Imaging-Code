...
set work [file join $fpga build usb3_harmonic_stream]
set vendor [file join $fpga vendor ch569_loopback_baseline]
file mkdir $work
create_project ch4_usb3_harmonic_stream $work -part xc7a200tfbg484-2 -force
...
write_bitstream -force [file join $work ch4_usb3_harmonic_stream.bit]
puts "USB3_HARMONIC_STREAM_BITSTREAM_PASS [file join $work ch4_usb3_harmonic_stream.bit]"
close_project
