...
set out [file join $fpga build real_fused_point_source_sim]
file mkdir $out
...
set files [list \
 ...
 [file join $fpga sim tb_ch4_real_fused_point_source.v]]
exec xvlog {*}$files
exec xelab --timescale 1ns/1ps tb_ch4_real_fused_point_source -s real_fused_point_source_sim
set result [exec xsim real_fused_point_source_sim -runall]
puts $result
if {[string first "REAL_FUSED_POINT_SOURCE_PASS" $result] < 0} {error "real fused point source test failed"}
