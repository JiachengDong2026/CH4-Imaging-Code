...
set work [file join $fpga build usb3_imaging_stream_variation]
set vendor [file join $fpga vendor ch569_loopback_baseline]
file mkdir $work
create_project ch4_usb3_imaging_stream_variation $work -part xc7a200tfbg484-2 -force
...
synth_design -top ch4_usb3_imaging_stream_top -part xc7a200tfbg484-2 -generic {GAS_VARIATION=1}
...
if {$worst < 0.0} {error "USB3 imaging variation timing failed: WNS=$worst ns"}
write_bitstream -force [file join $work ch4_usb3_imaging_stream_variation.bit]
puts "USB3_IMAGING_STREAM_VARIATION_PASS [file join $work ch4_usb3_imaging_stream_variation.bit]"
close_project
